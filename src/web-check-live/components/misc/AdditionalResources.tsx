...
const resources = [
  {
    title: 'Hudson Rock',
    link: 'https://hudsonrock.com/free-tools/?=sitesleuth',
...
const AdditionalResources = (props: { url?: string }): JSX.Element => {
  return (<Card heading="External Tools for Further Research" styles={CardStyles}>
    ...
    <Note>
      These tools are not affiliated with Site-Sleuth. Please use them at your own risk.<br />
      At the time of listing, all of the above were available and free to use
      - if this changes, please report it via GitHub (<a href="https://github.com/dlpra/site-sleuth">dlpra/site-sleuth</a>).
    </Note>
  </Card>);
}
