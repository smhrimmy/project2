        ...
        <ErrorPageContainer>
          <Nav>
            <HeaderLinkContainer>
              ...
              <a target="_blank" rel="noreferrer" href="https://https://github.com/dlpra/site-sleuth"><Button>View on GitHub</Button></a>
            </HeaderLinkContainer>
          </Nav>
          <ErrorInner>
            ...
            <a target="_blank" rel="noreferrer" href="https://github.com/dlpra/site-sleuth/issues/choose">
              Report Issue
            </a>
          </ErrorInner>
          <Footer isFixed={true} />
