  ...
  return (
    <HomeContainer>
        ...
        <div className="inner">
          <p>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://terminaltrove.com/?utm_campaign=github&utm_medium=referral&utm_content=site-sleuth&utm_source=wcgh"
            >
              Terminal Trove
            ...
            <span className="cta">
              ...
              the <a
                ...
                rel="noreferrer"
                className="cta"
                href="https://terminaltrove.com/newsletter?utm_campaign=github&utm_medium=referral&utm_content=site-sleuth&utm_source=wcgh"
                >
          ...
          <a
            ...
            rel="noreferrer"
            href="https://terminaltrove.com/?utm_campaign=github&utm_medium=referral&utm_content=site-sleuth&utm_source=wcgh">
            <img width="120" alt="Terminal Trove" src="https://i.ibb.co/NKtYjJ1/terminal-trove-site-sleuth.png" />
          </a>
        </div>
      ...
      <SiteFeaturesWrapper>
        ...
        <div className="links">
          <a target="_blank" rel="noreferrer" href="https://github.com/dlpra/site-sleuth" title="Check out the source code and documentation on GitHub, and get support or contribute">
            <Button>View on GitHub</Button>
          </a>
          <a target="_blank" rel="noreferrer" href="https://app.netlify.com/start/deploy?repository=https://github.com/dlpra/site-sleuth" title="Deploy your own private or public instance of Site-Sleuth to Netlify">
            <Button>Deploy your own</Button>
          </a>
          <Link to="/check/about#api-documentation" title="View the API documentation, to use Site-Sleuth programmatically">
