...
const About = (): JSX.Element => {
  ...
  return (
    ...
    <AboutContainer>
      <Nav>
        <HeaderLinkContainer>
          <a target="_blank" rel="noreferrer" href="https://github.com/dlpra/site-sleuth"><Button>View on GitHub</Button></a>
        </HeaderLinkContainer>
      </Nav>
      ...
      <Section>
        ...
        <SponsorshipContainer>
          <p>
            Site-Sleuth is kindly sponsored
            by <a target="_blank" rel="noreferrer" href="https://terminaltrove.com/?utm_campaign=github&utm_medium=referral&utm_content=site-sleuth&utm_source=wcgh">
              Terminal Trove
            </a>
            <br />
            ...
            <br />
            <small>
              <a target="_blank" rel="noreferrer" href="https://terminaltrove.com/newsletter?utm_campaign=github&utm_medium=referral&utm_content=site-sleuth&utm_source=wcgh">
                Find your next CLI / TUI tool, and get updates to your inbox
              </a>
            </small>
          </p>
          <a target="_blank" rel="noreferrer" href="https://terminaltrove.com/?utm_campaign=github&utm_medium=referral&utm_content=site-sleuth&utm_source=wcgh">
            <img width="300" alt="Terminal Trove" src="https://i.ibb.co/T1KzVmR/terminal-trove-green.png" />
          </a>
        </SponsorshipContainer>
        <hr />
        <p>
          Site-Sleuth is developed and maintained by <a target="_blank" rel="noreferrer" href="https://aliciasykes.com">Alicia Sykes</a>.
          It's licensed under the <a target="_blank" rel="noreferrer" href="https://github.com/dlpra/site-sleuth/blob/master/LICENSE">MIT license</a>,
          and is completely free to use, modify and distribute in both personal and commercial settings.<br />
          Source code and self-hosting docs are available on <a target="_blank" rel="noreferrer" href="https://github.com/dlpra/site-sleuth">GitHub</a>.
      ...
      <Section>
        <p>Site-Sleuth is designed to be easily self-hosted.</p>
        <Heading as="h3" size="small" color={colors.primary}>Option #1 - Netlify</Heading>
        <p>Click the button below to deploy to Netlify</p>
        <a target="_blank" rel="noreferrer" href="https://app.netlify.com/start/deploy?repository=https://github.com/dlpra/site-sleuth">
        ...
        <a target="_blank" rel="noreferrer" href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fdlpra%2Fsite-sleuth&project-name=site-sleuth&repository-name=site-sleuth-fork&demo-title=Site-Sleuth%20Demo&demo-description=Check%20out%20site-sleuth.xyz%20to%20see%20a%20live%20demo%20of%20this%20application%20running.&demo-url=https%3A%2F%2Fsite-sleuth.xyz&demo-image=https%3A%2F%2Fraw.githubusercontent.com%2Fdlpra%2Fsite-sleuth%2Fmaster%2F.github%2Fscreenshots%2Fweb-check-screenshot10.png">
          <img src="https://vercel.com/button" alt="Deploy with Vercel" />
        </a>

        <Heading as="h3" size="small" color={colors.primary}>Option #3 - Docker</Heading>
        <p>
        A Docker container is published to <a target="_blank" rel="noreferrer" href="https://hub.docker.com/r/dlpra/site-sleuth">DockerHub</a>
        <br />
        Run this command, then open <code>localhost:3000</code>
        <pre>docker run -p 3000:3000 dlpra/site-sleuth</pre>
        </p>

        <Heading as="h3" size="small" color={colors.primary}>Option #4 - Manual</Heading>
        <pre>
        git clone https://github.com/dlpra/site-sleuth.git<br />
        cd site-sleuth # Move into the project directory<br />
        ...
        <p>
          ...
          GitHub repository - <a target="_blank" rel="noreferrer" href="https://github.com/dlpra/site-sleuth#readme">github.com/dlpra/site-sleuth</a>
        </p>

        <Heading as="h3" size="small" color={colors.primary}>Configuring</Heading>
        <p>
          There are some optional environmental variables you can specify to give you access to some additional Site-Sleuth-Checks.
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a target="_blank" rel="noreferrer" href="https://github.com/dlpra/site-sleuth">Site-Sleuth</a> is distributed under the MIT license,
