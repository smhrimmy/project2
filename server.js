...
const renderPlaceholderPage = async (res, msgId, logs) => {
  const errorMessages = {
    ...
    disabledGui:  'Site-Sleuth API is up and running!<br />Access the endpoints at '
...
const printMessage = () => {
  console.log(
    ...
    ' \\___ \\| | __\\ \\ / \\___ \\| |/ / | | | __| \'_ \\ \n' +
    '  ___) | | |_\\ V /   ___) |   <| |_| | |_| | | |\n' +
    ' |____/|_|\\__|\_/   |____/|_|\\_\\\\__,_|\\__|_| |_|\n' +
    `\x1b[0m\n`,
    `\x1b[1m\x1b[32m🚀 Site-Sleuth is up and running at http://localhost:${port} \x1b[0m\n\n`,
